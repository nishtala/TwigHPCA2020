...
"""Check OpenAI Baselines repository for a description of the logging API.
...
# Following lines setup to only display log on terminal
...
def _demo():
    ...
    record_tabular("a", "some long text")
    dump_tabular()
